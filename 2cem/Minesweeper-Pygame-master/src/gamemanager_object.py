...
class GameManager(object):
    ...
    def buttons_press(self, mouse_pos, i):
        a = 35
        xy = [(mouse_pos[0], mouse_pos[1]), (mouse_pos[0]+a, mouse_pos[1]), (mouse_pos[0]-a, mouse_pos[1]),
              (mouse_pos[0], mouse_pos[1]+a), (mouse_pos[0], mouse_pos[1]-a), (mouse_pos[0]+a, mouse_pos[1]+a), 
              (mouse_pos[0]-a, mouse_pos[1]+a), (mouse_pos[0]+a, mouse_pos[1]-a), (mouse_pos[0]-a, mouse_pos[1]-a)]
        return(xy[i])      
    ...
    def handle_input(self):
        ...
        if mouse_button_state[2] and self.left_mouse_held:
            self.lr_mouse_held = True
            clicked_celll = []
            if self.i == 1:
                for i in range (9):
                    if self.buttons_press(mouse_pos, i)[0] > 35 and self.buttons_press(mouse_pos, i)[1] > 155 and self.buttons_press(mouse_pos, i)[0] < 1150 and self.buttons_press(mouse_pos, i)[1] < 685:
                        clicked_celll.append( self.grid.get_clicked_cell(self.buttons_press(mouse_pos, i)))
